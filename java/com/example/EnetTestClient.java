...
public class EnetTestClient {
    ...
    public static void main(String[] args) throws UnknownHostException {
        ...
        ENetAddress address2 = new ENetAddress();
        ENetHost host = enet.enet_host_create(address2 ,1, 2, 0, 0);
        if (host == null) {
        ...
        while(true){
            ...
            while ( ret > 0){
                ...
                if(t.equals(ENetEventType.ENET_EVENT_TYPE_CONNECT)){
                    ...
                    System.out.println("received string = " + new String(bytes, Charset.defaultCharset()));
